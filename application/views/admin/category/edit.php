        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('category_name') != "") ? 'is-invalid' : '';?>" placeholder="Edit category name"
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('description') != "") ? 'is-invalid' : '';?>" placeholder="Edit Description"
                        rows="10" value="<?php echo set_value('description', $category['description']);?>" >             <?php echo set_value('description', $category['description']);?></textarea>
                    <span></span>
