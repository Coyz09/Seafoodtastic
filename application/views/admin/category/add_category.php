        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                   ...
                   <textarea placeholder="Add Category Description" rows="10" type="text" name="description" id="description" 
                    class="form-control <?php echo (form_error('description') != "") ? 'is-invalid' : '';?>"
                    value="<?php echo set_value('description');?>"></textarea><?php echo form_error('description'); ?>
                    <span></span>
