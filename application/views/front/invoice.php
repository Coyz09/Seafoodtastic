    ...
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <div class="invoice mb-3">
            <div class="row mb-3 p-3">
                <div class="col-6">
                    <h3 style="color:#007dbb"><i class="fas fa-fish"></i><b>Seafoodtastic</b></h3>
                </div>
                <div class="col-6">
                    <h3>INVOICE:</h3>
                    ...
                    <table class="table responsive">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span>&#8369;</span><?php echo $pro['price']; ?></td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td class="font-weight-bold">Total</td>
                                <td class="font-weight-bold"><span>&#8369;</span><?php echo $order['price'] ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
